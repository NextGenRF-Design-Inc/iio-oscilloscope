...
module adrv9001_rx #(
  ...
  if (CMOS_LVDS_N == 0) begin
    ...
    if( SWAP_DIFF_IDATA == 1 ) begin
      assign adc_data_0[0] = ~data_s0[0];
      assign adc_data_0[1] = ~data_s1[0];
      assign adc_data_0[2] = ~data_s2[0];
      assign adc_data_0[3] = ~data_s3[0];
      assign adc_data_0[4] = ~data_s4[0];
      assign adc_data_0[5] = ~data_s5[0];
      assign adc_data_0[6] = ~data_s6[0];
      assign adc_data_0[7] = ~data_s7[0];
    end else begin
      assign adc_data_0[0] =  data_s0[0];
      assign adc_data_0[1] =  data_s1[0];
      assign adc_data_0[2] =  data_s2[0];
    ...
    if( SWAP_DIFF_QDATA == 1 ) begin
      assign adc_data_1[0] = ~data_s0[1];
      assign adc_data_1[1] = ~data_s1[1];
      assign adc_data_1[2] = ~data_s2[1];
      assign adc_data_1[3] = ~data_s3[1];
      assign adc_data_1[4] = ~data_s4[1];
      assign adc_data_1[5] = ~data_s5[1];
      assign adc_data_1[6] = ~data_s6[1];
      assign adc_data_1[7] = ~data_s7[1];
    end else begin
      assign adc_data_1[0] =  data_s0[1];
      assign adc_data_1[1] =  data_s1[1];
      assign adc_data_1[2] =  data_s2[1];
    ...
    if( SWAP_DIFF_STROBE == 1 ) begin
      assign adc_data_strobe[0] = ~data_s0[2];
      assign adc_data_strobe[1] = ~data_s1[2];
      assign adc_data_strobe[2] = ~data_s2[2];
      assign adc_data_strobe[3] = ~data_s3[2];
      assign adc_data_strobe[4] = ~data_s4[2];
      assign adc_data_strobe[5] = ~data_s5[2];
      assign adc_data_strobe[6] = ~data_s6[2];
      assign adc_data_strobe[7] = ~data_s7[2];
    end else begin
      assign adc_data_strobe[0] =  data_s0[2];
      assign adc_data_strobe[1] =  data_s1[2];
      assign adc_data_strobe[2] =  data_s2[2];
