...
wire [7:0] idata_serdes_in;
wire [7:0] qdata_serdes_in;
wire [7:0] strb_serdes_in;
wire [7:0] dclk_serdes_in;

generate
  if (CMOS_LVDS_N == 0) begin

    if( SWAP_DIFF_IDATA == 1 ) begin
      assign idata_serdes_in = ~dac_data_0;
    end else begin
      assign idata_serdes_in = dac_data_0;
    end

    if( SWAP_DIFF_QDATA == 1 ) begin
      assign qdata_serdes_in = ~dac_data_1;
    end else begin
      assign qdata_serdes_in = dac_data_1;
    end

    if( SWAP_DIFF_STROBE == 1 ) begin
      assign strb_serdes_in = ~dac_data_strb;
    end else begin
      assign strb_serdes_in = dac_data_strb;
    end

    if( SWAP_DIFF_DCLK == 1 ) begin
      assign dclk_serdes_in = ~dac_data_clk;
    end else begin
      assign dclk_serdes_in = dac_data_clk;
    end
    ...
    assign data_s0 = {dclk_serdes_in[7],strb_serdes_in[7],qdata_serdes_in[7],idata_serdes_in[7]};
    assign data_s1 = {dclk_serdes_in[6],strb_serdes_in[6],qdata_serdes_in[6],idata_serdes_in[6]};
    assign data_s2 = {dclk_serdes_in[5],strb_serdes_in[5],qdata_serdes_in[5],idata_serdes_in[5]};
    assign data_s3 = {dclk_serdes_in[4],strb_serdes_in[4],qdata_serdes_in[4],idata_serdes_in[4]};
    assign data_s4 = {dclk_serdes_in[3],strb_serdes_in[3],qdata_serdes_in[3],idata_serdes_in[3]};
    assign data_s5 = {dclk_serdes_in[2],strb_serdes_in[2],qdata_serdes_in[2],idata_serdes_in[2]};
    assign data_s6 = {dclk_serdes_in[1],strb_serdes_in[1],qdata_serdes_in[1],idata_serdes_in[1]};
    assign data_s7 = {dclk_serdes_in[0],strb_serdes_in[0],qdata_serdes_in[0],idata_serdes_in[0]};
