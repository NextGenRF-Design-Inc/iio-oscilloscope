...
module system_top (
  ...
  system_wrapper i_system_wrapper (
    ...
    .rx2_idata_in_n (rx2_idata_in_p),
    .rx2_idata_in_p (rx2_idata_in_n),
    .rx2_qdata_in_n (rx2_qdata_in_p),
    .rx2_qdata_in_p (rx2_qdata_in_n),
    .rx2_strobe_in_n (rx2_strobe_in_p),
    .rx2_strobe_in_p (rx2_strobe_in_n),

    .tx1_dclk_out_n (tx1_dclk_out_n),
    .tx1_dclk_out_p (tx1_dclk_out_p),
    .tx1_dclk_in_n (tx1_dclk_in_n),
    .tx1_dclk_in_p (tx1_dclk_in_p),
    .tx1_idata_out_n (tx1_idata_out_p),
    .tx1_idata_out_p (tx1_idata_out_n),
